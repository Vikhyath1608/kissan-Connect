...
<html lang="en">
	...
	<body>
		...
		<div class="footer-left">
			<h3 style="font-family: 'Times New Roman', cursive;">KissanConnect &copy; </h3>
			<br />
			<p style="font-size:20px;color:white">Your product Our Website !!!</p>
			<br />
		</div>
		...
		<div class="footer-center">
			<div>
				...
				<p style="font-size:20px">KissanConnect Office<span>Moodbidri	</span></p>
			</div>
			<div>
			...
			<div>
				...
				<p style="font-size:20px"><a href="mailto:4al21cs146@gmail.com" style="color:white">syashvi@gmail.com</a></p>
			</div>
		</div>

		<div class="footer-right">
			<p class="footer-company-about" style="color:white">
				<span style="font-size:20px"><b>About KissanConnect</b></span>
				KissanConnect is e-commerce trading platform for grocerries...
			</p>
