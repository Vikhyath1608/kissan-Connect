...
<html>
<head>
	<title>KissanConnect: Product</title>
	<meta lang="eng">
	<meta charset="UTF-8">
		<title>KissanConnect</title>
...
<body>
                                ...
                                <div class="row uniform">
                                  <?php if($bid != "") { ?>
									<div class="6u 12u$(large)">
                                        <a href="favorites.php?flag=1&pid=<?= $pid; ?>" class="btn btn-primary" style="text-decoration: none;"><span class="glyphicon glyphicon-shopping-cart"> Add To Favourites</a>
                                    </div>
                                    <div class="6u 12u$(large)">
			...
			?>
			<div class="container">
				<p style="font: 20px Times new roman; text-align: left;">Rate this product</p>
